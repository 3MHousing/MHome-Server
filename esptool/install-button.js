    ...
    connectedCallback() {
        ...
        !t.isSupported || !t.isAllowed)
            ...
            void (this.renderRoot.innerHTML = t.isAllowed 
                ? "<slot name='unsupported'>Trình duyệt của bạn không hỗ trợ. Hãy sử dụng Google Chrome hoặc Microsoft Edge.</slot>" 
                : "<slot name='not-allowed'>Bạn chỉ cài đặt cho thiết bị trên HTTPS hoặc trên localhost.</slot>"
                );
...
customElements.define("mhome-web-tool-button", t);
